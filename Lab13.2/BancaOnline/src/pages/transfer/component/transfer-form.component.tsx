...
import { AccountVm, TransferVm, TransferError, createEmptyTransfer, createEmptyTransferError } from "../transfer.vm";
...
export const TransferFormComponent : React.FC<Props> = (props) => {
    ...
    const [transfer,  setTransfer] = useState<TransferVm>(
        createEmptyTransfer()
    );
    ...
    <div>
        <form onSubmit={handleSubmit}> 
            <div className={classes.formContainer}>  
                <div>
                    ...
                    <select 
                        ...
                        className={`${classes.accountSelect} ${classes.large}`}
                    > 
                        {
            ...
            <div className={classes.formContainer}>         
                <div>   
                    <p>
                        Para que la transferencia se realice 
                        en otra fecha diferente a la de
